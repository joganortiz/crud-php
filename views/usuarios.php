...
<head>
    ...
    <!-- Datatable -->
    <link rel="stylesheet" type="text/css" href="Assets/js/datatables.net-bs4/css/dataTables.bootstrap4.css">
    <link rel="stylesheet" type="text/css" href="Assets/js/datatables.net-bs4/css/responsive.dataTables.min.css">
...
<body>
    ...
    <script src="Assets/js/datatables.net-bs4/js/dataTables.responsive.min.js"></script>
